...
open class CircularSpinner: UIView {
    ...
    public static var trackBgColor = UIColor(displayP3Red: 238.0/255, green: 238.0/255, blue: 238.0/255, alpha: 1)
    private var bgColor = trackBgColor {
        didSet {
            appearanceBackgroundLayer()
        }
    }
    public static var trackPgColor = UIColor(displayP3Red: 27.0/255, green: 160.0/255, blue: 227.0/255, alpha: 1)
...
extension CircularSpinner {
    ...
    open class func show(_ title: String = "", animated: Bool = true, type: CircularSpinnerType = .indeterminate, showDismissButton: Any? = nil, delegate: CircularSpinnerDelegate? = nil) {
        let spinner = CircularSpinner.sharedInstance
        spinner.type = type
